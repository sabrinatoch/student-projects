...
namespace HVK.Controllers
{
    public class ReservationsController : Controller
    {
        ...
        public ReservationsController(HVKW24_Team3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Reservations != null ? 
                          ...
                          Problem("Entity set 'HVKW24_Team3Context.Reservations'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'HVKW24_Team3Context.Reservations'  is null.");
            }
            var reservation = await _context.Reservations.FindAsync(id);
            if (reservation != null)
            {
