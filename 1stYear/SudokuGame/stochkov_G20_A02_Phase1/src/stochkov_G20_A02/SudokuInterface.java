...
public class SudokuInterface {
	...
	private static SudokuGame sudoku = null;
		...
		while (!validFile) {
			if (filename.equalsIgnoreCase("X"))
				try {
					...
					System.out.println("sudoku.txt will be used as the default game file.");
					break;
				} // try
				catch (IOException e) {
	...
	public static void validChar(String ch) {
